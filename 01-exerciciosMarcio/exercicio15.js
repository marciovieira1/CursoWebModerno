 ...
 * “Compra efetuada com sucesso”. Nas outras opções, retorne: “Tem certeza que não 
 * prefere este modelo?”. Caso seja especificado um modelo que não está disponível, 
 ...
 function comprarCarro(modelo){
     switch(modelo){
        ...
        case 'sedans': case 'motocicletas': case 'caminhonetes':
            console.log("Tem certeza que deseja este modelo?")
            break
        default:
